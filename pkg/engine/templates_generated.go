...
{{- end}}
      ...
      containers:
        - name: csi-provisioner
          ...
          args:
{{- if IsKubernetesVersionGe "1.28.0"}}
...
function Get-LogCollectionScripts {
    ...
    mkdir 'c:\k\debug'
    DownloadFileOverHttp -Url 'https://github.com/Azure/aks-engine-azurestack/raw/master/scripts/collect-windows-logs.ps1' -DestinationPath 'c:\k\debug\collect-windows-logs.ps1'
